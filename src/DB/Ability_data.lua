local AbilityData = {
    ...
    ["Warframe"] = {
      ["Ash"] = {"Shuriken","Écran de Fumée","Téléportation","Tempête de Lames"},
      ["Atlas"] = {"Éboulement","Tectonique","Pétrification","Golems"},
      ["Banshee"] = {"Explosion Sonique","Sonar","Silence","Secousse Sonique"},
      ["Baruuk"] = {"Esquive","Accalmie","Mains Amères","Tempête Reposante"},
      ["Chroma"] = {"Hurlement Spectral","Protection Élémentaire","Armure Vex","Effigie"},
      ...
      ["Hydroid"] = {"Barrage Tempête","Raz de Marée","Contre-Courant","Déluge de Tentacules"},
      ["Inaros"] = {"Dessiccation","Inhumation","Tempête de Sable","Nuée de Scarabées"},
      ...
      ["Loki"] = {"Leurre","Invisibilité","Transposition","Désarmement Radial"},
      ["Mag"] = {"Attraction","Magnétisation","Polarisation","Écrasement"},
      ["Mesa"] = {"Batterie Balistique","Salle de tir","Bouclier Scélérat","Pacificateurs"},
      ["Mirage"] = {"Galerie des Glaces","Tour de Passe","Éclipse","Prisme"},
      ["Nekros"] = {"Perforation d'Âme","Terreur","Profanation","Ombres des Morts"},
      ["Nezha"] = {"Danse du Feu","Chakram Flamboyant","Halo Protecteur","Lances Divines"},
      ["Nidus"] = {"Virulence","Larve","Lien Parasitaire","Voracité"},
      ["Nova"] = {"Étoile Vide","Lâché d'Antimatière","Trou de Ver","Amorce Moléculaire"},
      ["Nyx"] = {"Contrôle Mental","Carreaux Psychiques","Chaos","Absorption"},
      ["Oberon"] = {"Châtiment","Bénédiction Terrestre","Renouveau","Jugement"},
      ...
      ["Xaku"] = {"Murmure de Xata","Étreinte de Lohk","L'Égaré","Vide Intemporel"},
    },
  }
