local p = {
    ...
    ["REF"] = {
        ...
        ["ImageTier"] = {
            [1] = {"VoidProjectionsIronD.png", "VoidProjectionsIronA.png", "VoidProjectionsIronB.png", "VoidProjectionsIronC.png"},
