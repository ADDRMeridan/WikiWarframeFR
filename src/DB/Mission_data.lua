    ...
    ["MissionDetails"] = {
        {
            ...
            Node = "Vallée Orbis",
            Planet = "Venus",
            Type = "Landscape|Exploration Libre",
            ...
            Type = "Extermination",
            Tileset = "Astéroïde Grineer Fortress",
            Enemy = "Grineer",
            MinLevel = 28,
            MaxLevel = 30,
            Tier = "KuvaCaches"
        ...
        -- { Node = "Free Flight", Planet = "Proxima de la Terre", Type = "Landscape|Exploration Libre", Tileset = "Exploration Libre"},
        {
            Node = "Amas Posit",
