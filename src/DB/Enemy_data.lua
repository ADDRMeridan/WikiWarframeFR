local EnemyData = {
    ...
    ["Comba Brouil. Juno"] = {
        ...
        Family = "Comba Brouil.",
        HealthTypes = {["Bouclier"] = 400, ["Chair"] = 1100},
        Image = "Comba Brouillard Juno.png",
        Introduced = "28.0",
        Link = nil,
        Name = "Comba Brouil. Juno",
        NameEN = "Juno Fog Comba",
        Regions = nil,
        Scans = 3,
        Weapons = {"Convectrix"}
    },
