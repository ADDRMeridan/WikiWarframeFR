local AbilityData = {
    ["Ability"] = {
        ...
        ["Piège de Cristal"] = {
            ...
            Cost = nil,
            Key = 2,
            Description = "Foncez en avant, écrasant les ennemis et laissant une traînée glacée de cristaux brisés. Maintenez pour imprégner de {{Glace|text}} le prochain Pouvoir.",
        ...
        ["Catalyseur"] = {
            ...
            Cost = nil,
            Key = 4,
            Description = "Des Sondes catalytiques jaillissent de Lavos et aspergent les combattants d'un gel brûlant. Les Dégâts sont doublés pour chaque élément affectant un ennemi. Maintenez pour imprégner de {{Feu|text}} le prochain Pouvoir lancé.",
