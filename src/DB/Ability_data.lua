-- Source: https://warframe.fandom.com/wiki/Module:Ability/data
...
local AbilityData = {
    ["Ability"] = {
        ...
        ["L'Égaré"] = {
            Cost = 75,
            Key = 3,
            Description = "Parcourez et lancez un des trois Pouvoirs distincts provenant de Warframes tombées au combat et qui composent Xaku: Accusation, Regard et Déni.",
