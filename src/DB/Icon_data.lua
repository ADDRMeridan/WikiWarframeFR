local IconData = {
    ...
    ["Objets"] = {
        ...
        ["Décoration Couronne Granum Exemplaire"] = {
            icon = "Couronne Granum Exemplaire.png",
            link = "Orbiteur"
        },
        ["Décoration Couronne Granum Zénith"] = {
    ...
    ["Polarités"] = {
        -- Nom Complet
        ["Madurai"] = {
            icon = {"V.png", "V.png"}, -- Pas de version noire
            color = ""
        },
        ["Naramon"] = {
            icon = {"Bar.png", "Bar.png"}, -- Pas de version noire
            color = ""
        },
        ["Penjaga"] = {
        ...
        ["Vazarin"] = {
            icon = {"D.png", "D.png"}, -- Pas de version noire
            color = ""
        },
        ["Zenurik"] = {
            icon = {"Ability.png", "Ability.png"}, -- Pas de version noire
            color = ""
        },
        ["Aura"] = {
            icon = {"Aura_Pol_Blanc.png", "Aura_Pol_Blanc.png"}, -- Pas de version noire
            color = ""
        },
        ["Koneksi"] = {
            icon = {"Corepol.png", "Corepol.png"}, -- Pas de version noire
            color = ""
        },
        ...
        ["O"] = {
            icon = {"O.png", "O.png"}, -- Pas de version noire
            color = ""
        },
        ["Z"] = {
            icon = {"Ability.png", "Ability.png"}, -- Pas de version noire
    ...
    ["Factions"] = {
        ...
        ["Infesté"] = {
            icon = {"IconInfestedB.png", "IconInfestedW.png"},
            link = "Infestés"
        },
        ["Infestés"] = {
            icon = {"IconInfestedB.png", "IconInfestedW.png"},
        ...
        ["Non-affilié"] = {
            icon = {"IconWildW.png", "IconWildOn.png"},
            link = "Non-affilié"
        },
        ["Syndicats"] = {
        ...
        -- Pas une faction a proprement parler mais requis pour les icones de missions
        ["Feux Croisés"] = {
            icon = {"FeuxCroisesn.png", "FeuxCroisesn.png"},
            link = "Feux Croisés"
        }
    },
    ...
    ["Poisson"] = {
        ["Anguille Charc"] = {
            icon = "CharcEel.png",
            link = "Pêcher#Poissons des Plaines d'Eidolon"
        },
        ["Mawfish"] = {
            icon = "Mawfish.png",
            link = "Pêcher#Poissons des Plaines d'Eidolon"
    ...
    ["Ressources"] = {
        ...
        ["Extrait de Nitain"] = {
            icon = "ExtraitNitain.png",
            link = "Extrait de Nitain"
        },
        ...
        ["Lentille Focus 2"] = {
            icon = "FocusLens2.png",
            link = "Lentilles de Focus#Lentille Supérieure"
        },
        ["Lentille Focus 3"] = {
            icon = "EidolonLens.png",
            link = "Lentilles de Focus#Lentille Eidolon"
        },
        ["Fragment d'Injecteur d'Antisérum"] = {
            icon = "Actuator.png",
        ...
        ["Module de Contrôle"] = {
            ...
            link = "Module de Contrôle"
        },
        ["Ampoule de Détonite"] = {
            icon = "DetoniteAmpule64.png",
            link = "Ampoule de Détonite"
        },
        ["Injecteur de Détonite"] = {
        ...
        ["Eclat d'Eidolon Rayonnant"] = {
            icon = "RadiantEidolonShard.png",
            link = "Eclat d'Eidolon Rayonnant"
        },
        ["Extrait de Jadeleaf de Jour"] = {
            icon = "SamplesDayRare.png",
            link = "Jadeleaf de Jour"
        },
        ["Extrait de Jadeleaf de Nuit"] = {
            icon = "SamplesNightRare.png",
            link = "Jadeleaf de Nuit"
        },
        ["Extrait de Dragonlily de Jour"] = {
            icon = "SamplesDayUncommon.png",
            link = "Dragonlily de Jour"
        },
        ["Extrait de Dragonlily de Nuit"] = {
            icon = "SamplesNightUncommon.png",
            link = "Dragonlily de Nuit"
        },
        ["Extrait de Threshcone de Jour"] = {
            icon = "SamplesDayCommon.png",
            link = "Threshcone de Jour"
        },
        ...
        ["Essence Pyrique"] = {
            icon = "Essence_Pyrique.png",
            link = "Essence Pyrique"
        },
        ["Essence Trembera"] = {
        ...
        ["Tentacules Infectés"] = {
            ...
            link = "Tentacules Infectés"
        },
        ["Squame Chitineux"] = {
            icon = "JuggernautChitinousHusk.png",
            link = "Squame Chitineux"
        },
        ["Sac de Bile Tranché"] = {
            icon = "JuggernautBileSac.png",
            link = "Sac de Bile Tranché"
        },
        ["Aspect Jour Equinox"] = {
            icon = "EquinoxJour.png",
            link = "Aspect Jour Equinox"
        },
        ["Aspect Nuit Equinox"] = {
            icon = "EquinoxNuit.png",
            link = "Aspect Nuit Equinox"
        },
        ["Coeur de Sentient Intact"] = {
            icon = "QuillsCommonPickup.png",
            link = "Coeur de Sentient"
        },
        ["Coeur de Sentient Exceptionnel"] = {
            icon = "QuillsUncommonPickup-0.png",
            link = "Coeur de Sentient"
        },
        ["Coeur de Sentient Parfait"] = {
        ...
        ["Diodes Cubiques"] = {
            icon = "Diodes Cubiques.png",
            link = "Diodes Cubiques"
        },
        ["Drone de Réparation Avancé"] = {
        ...
        ["Jadeleaf de Nuit"] = {
            icon = "JadeleafdeNuit.png",
            link = "Jadeleaf de Nuit"
        },
        ["Mousse Vestale"] = {
            icon = "Mousse_Vestale.png",
            link = "Mousse Vestale"
        },
        ["Sarracénie Crépusculaire"] = {
            icon = "Sarracénie Crépusculaire.png",
            link = "Sarracénie Crépusculaire"
        },
        ["Threshcone de Jour"] = {
            icon = "Threshcone_de_Jour.png",
            link = "Threshcone de Jour"
        },
        ["Threshcone de Nuit"] = {
        ...
        ["Aile de Condroc"] = {
            icon = "Aile_de_Condroc.png",
            link = "Aile de Condroc"
        },
        ["Griffe Dorsale de Kuaka"] = {
            icon = "Griffe_Dorsale_de_Kuaka.png",
            link = "Griffe Dorsale de Kuaka"
        },
        ["Feu Follet de Cetus"] = {
            icon = "Feu_Follet_de_Cetus.png",
            link = "Feu Follet de Cetus"
        },
        ["Souffle d'Eidolon"] = {
            icon = "Souffle_d'Eidolon.png",
            link = "Souffle d'Eidolon"
        },
        ["Eclat d'Eidolon"] = {
        ...
        ["Huile de Poisson"] = {
            icon = "Huile_de_Poisson.png",
            link = "Huile de Poisson"
        },
        ["Ecaille de Poisson"] = {
            icon = "Ecaille_de_Poisson.png",
            link = "Ecaille de Poisson"
        },
        ["Charc Electroplax"] = {
            icon = "Charc_Electroplax.png",
            link = "Charc Electroplax"
        },
        ["Tentacules de Cuthol"] = {
            icon = "Tentacules_de_Cuthol.png",
            link = "Tentacules de Cuthol"
        },
        ["Rate de Goopolla"] = {
            icon = "Rate_de_Goopolla.png",
            link = "Rate de Goopolla"
        },
        ["Antenne de Karkina"] = {
            icon = "Antenne_de_Karkina.png",
            link = "Antenne de Karkina"
        },
        ["Poche à Venin Khut-Khut"] = {
            icon = "Poche_à_Venin_Khut-Khut.png",
            link = "Poche à Venin Khut-Khut"
        },
        ["Arêtes de Mawfish"] = {
            icon = "Arêtes_de_Mawfish.png",
            link = "Arêtes de Mawfish"
        },
        ["Corne de Mortus"] = {
            icon = "Corne_de_Mortus.png",
            link = "Corne de Mortus"
        },
        ["Foie de Murkray"] = {
            icon = "Foie_de_Murkray.png",
            link = "Foie de Murkray"
        },
        ["Cerveau de Norg"] = {
            icon = "Cerveau_de_Norg.png",
            link = "Cerveau de Norg"
        },
        ["Carapace de Scarabée Seram"] = {
            icon = "Carapace_de_Scarabée_Seram.png",
            link = "Carapace de Scarabée Seram"
        },
        ["Dents de Sharrac"] = {
            icon = "Dents_de_Sharrac.png",
            link = "Dents de Sharrac"
        },
        ["Yeux de Tralok"] = {
            icon = "Yeux_de_Tralok.png",
            link = "Yeux de Tralok"
        },
        ["Estomac de Yogwun"] = {
            icon = "Estomac_de_Yogwun.png",
            link = "Estomac de Yogwun"
        },

        -- Ressources de Fortuna
        ["Spore Gorgaricus"] = {
            icon = "SporeGorgaricus.png",
            link = "Spore Gorgaricus"
        },
        ["Spore Mytocardia"] = {
        ...
        ["Obligations de dettes Familiales"] = {
            icon = "Obligations_de_dettes_Familiales.png",
            link = "Obligations de dettes Familiales"
        },
        ["Obligations de dettes d'avance de fonds"] = {
            icon = "Obligations_de_dettes_d'avance_de_fonds.png",
            link = "Obligations de dettes d'avance de fonds"
        },
        ["Obligations de dettes Médicales"] = {
            icon = "Obligations_de_dettes_Médicales.png",
            link = "Obligations de dettes Médicales"
        },
        ["Obligations de dettes de Couverture"] = {
            icon = "Obligations_de_dettes_de_Couverture.png",
            link = "Obligations de dettes de Couverture"
        },
        ["Obligations de dettes Étudiantes"] = {
        ...
        ["Bobine Dissipatrice"] = {
            icon = "Bobine_Dissipatrice.png",
            link = "Bobine Dissipatrice"
        },
        ["Analyseur Écosynth"] = {
        ...
        ["Systèmes Atmo"] = {
            icon = "Systèmes_Atmo.png",
            link = "Systèmes Atmo"
        },
        ["Systèmes Gyromag"] = {
            icon = "Systèmes_Gyromag.png",
            link = "Systèmes Gyromag"
        },
        ["Thermia Dilué"] = {
        ...
        ["Antigène Desus"] = {
            icon = "Antigène Desus.png",
            link = "Antigène Desus"
        },
        ["Antigène Elasmun"] = {
            icon = "Antigène Elasmun.png",
            link = "Antigène Elasmun"
        },
        ["Antigène Ibexan"] = {
            icon = "Antigène Ibexan.png",
            link = "Antigène Ibexan"
        },
        ["Antigène Iranon"] = {
            icon = "Antigène Iranon.png",
            link = "Antigène Iranon"
        },
        ["Antigène Plagen"] = {
            icon = "Antigène Plagen.png",
            link = "Antigène Plagen"
        },
        ["Antigène Poxi"] = {
            icon = "Antigène Poxi.png",
            link = "Antigène Poxi"
        },
        ["Antigène Tethron"] = {
            icon = "Antigène Tethron.png",
            link = "Antigène Tethron"
        },
        ["Antigène Virox"] = {
        ...
        ["Cabochon Embolos"] = {
            icon = "Cabochon Embolos.png",
            link = "Cabochon Embolos"
        },
        ["Canon d'Arme de Necramech Endommagé"] = {
            icon = "Canon d'Arme Necramech Endommagé.png",
            link = "Canon d'Arme de Necramech Endommagé"
        },
        ["Châssis de Necramech Endommagé"] = {
            icon = "Châssis de Necramech Endommagé.png",
            link = "Châssis de Necramech Endommagé"
        },
        ["Crosse d'Arme de Necramech Endommagé"] = {
            icon = "Crosse d'Arme Necramech Endommagé.png",
            link = "Crosse d'Arme de Necramech Endommagé"
        },
        ["Culasse d'Arme de Necramech Endommagé"] = {
        ...
        ["Dendrite de Blastomes"] = {
            icon = "Dendrite de Blastomes.png",
            link = "Dendrite de Blastomes"
        },
        ["Dépôt de Sebum"] = {
            icon = "Dépôt de Sebum.png",
            link = "Dépôt de Sebum"
        },
        ["Distillat Thaumique"] = {
            icon = "Distillat Thaumique.png",
            link = "Distillat Thaumique"
        },
        ["Éclat de Sériglas"] = {
        ...
        ["Jeton de la Mère"] = {
            icon = "Jeton de la Mère.png",
            link = "Jeton de la Mère"
        },
        ["Jeton du Père"] = {
            icon = "Jeton du Père.png",
            link = "Jeton du Père"
        },
        ["Jeton Avichaea Commun"] = {
        ...
        ["Masse Musculaire Saturée"] = {
            icon = "Masse Musculaire Saturée.png",
            link = "Masse Musculaire Saturée"
        },
        ["Matrice Animus Orokin"] = {
            icon = "Matrice Animus Orokin.png",
            link = "Matrice Animus Orokin"
        },
        ["Matrice Balistique Orokin"] = {
            icon = "Matrice Balistique Orokin.png",
            link = "Matrice Balistique Orokin"
        },
        ["Matrice d'Orientation Orokin"] = {
            icon = "Matrice d'Orientation Orokin.png",
            link = "Matrice d'Orientation Orokin"
        },
        ["Moteur de Necramech Endommagé"] = {
            icon = "Moteur de Necramech Endommagé.png",
            link = "Moteur de Necramech Endommagé"
        },
        ["Mutagène Adra"] = {
        ...
        ["Mutagène Chiten"] = {
            icon = "Mutagène Chiten.png",
            link = "Mutagène Chiten"
        },
        ["Mutagène Elsa"] = {
            icon = "Mutagène Elsa.png",
            link = "Mutagène Elsa"
        },
        ["Mutagène Leptosam"] = {
            icon = "Mutagène Leptosam.png",
            link = "Mutagène Leptosam"
        },
        ["Mutagène Monachod"] = {
            icon = "Mutagène Monachod.png",
            link = "Mutagène Monachod"
        },
        ["Mutagène Phijar"] = {
            icon = "Mutagène Phijar.png",
            link = "Mutagène Phijar"
        },
        ["Mutagène Zarim"] = {
            icon = "Mutagène Zarim.png",
            link = "Mutagène Zarim"
        },
        ["Nacelle de Necramech Endommagée"] = {
            icon = "Nacelle de Necramech Endommagée.png",
            link = "Nacelle de Necramech Endommagée"
        },
        ["Nacelle d'Armes de Necramech Endommagée"] = {
        ...
        ["Système de Branchies Tuberculaires"] = {
        ...
        ["Tumeur Bénine Infestée"] = {
            ...
            link = "Tumeur Bénine Infestée"
        },
        ["Vessie de Fermentation"] = {
    ...
    ["Procs"] = {
        ...
        -- Physiques
        ["Impact"] = {
            icon = {"Impact_w.png", "icon_proc_impact_blanc.png"},
            link = "Dégâts/Dégâts Impact",
            color = "#778899"
        },
        ["Perforation"] = {
            icon = {"Pénétration_w.png", "icon_proc_perforation_blanc.png"},
            link = "Dégâts/Dégâts Perforation",
            color = "#778899"
        },
        ["Tranchant"] = {
            icon = {"Tranchant_w.png", "icon_proc_tranchant_blanc.png"},
            link = "Dégâts/Dégâts Tranchant",
            color = "#778899"
        },

        -- Élementaires
        ["Glace"] = {
            icon = {"Gel_w.png", "Gel_w.png"},
            link = "Dégâts/Dégâts Glace",
            color = "#339FFF"
        },
        ["Électrique"] = {
            icon = {"Electrique_n.png", "Electrique.png"},
            link = "Dégâts/Dégâts Électrique",
            color = "#FFFF00"
        },
        ["Feu"] = {
            icon = {"Heat_b.png", "icon_proc_feu_blanc.png"},
            link = "Dégâts/Dégâts Feu",
            color = "#FF0000"
        },
        ["Poison"] = {
            icon = {"Poison_n.png", "Poison_b.png"},
            link = "Dégâts/Dégâts Poison",
            color = "#008000"
        },
        ...
        ["Explosif"] = {
            ...
            link = "Dégâts/Dégâts Explosif",
            color = "#B45F04"
        },
        ["Corrosif"] = {
            icon = {"Corrosive_b.png", "Corrosive_w.png"},
            link = "Dégâts/Dégâts Corrosif",
            color = "#9ACD32"
        },
        ["Gaz"] = {
            icon = {"Gas_b.png", "Gas_w.png"},
            link = "Dégâts/Dégâts Gaz",
            color = "#71905E"
        },
        ["Magnétique"] = {
            icon = {"Magnetic_b.png", "Magnetic_w.png"},
            link = "Dégâts/Dégâts Magnétique",
            color = "#0033CC"
        },
        ["Radiation"] = {
            icon = {"Radiation_b.png", "Radiation_w.png"},
            link = "Dégâts/Dégâts Radiation",
            color = "#088A85"
        },
        ["Viral"] = {
            icon = {"Viral_b.png", "Viral_w.png"},
            link = "Dégâts/Dégâts Viral",
            color = "#886A08"
        },

        -- Types Uniques
        ["Brut"] = {
            icon = {"degats_brut_noir.png", "degats_brut_blanc.png"},
            link = "Dégâts/Dégâts Brut",
            color = "#FFFFFF"
        },
        ["Néant"] = {
            icon = {"icon_proc_vide_noir.png", "icon_proc_vide_blanc.png"},
            link = "Dégâts/Dégâts Néant",
            color = "#BAB000"
        },
        ["Tau"] = {
            icon = {"icon_proc_tau_noir.png", "icon_proc_tau_blanc.png"},
            link = "Dégâts#Dégâts Uniques",
            color = "#E8AB1E"
        },
        ...
        ["Projeter"] = {
            icon = {"Ragdoll_b.svg", "Ragdoll_w.svg"},
            link = "Projeter"
        },
        ["Renversement"] = {
            icon = {"Knockdown_b.svg", "Knockdown_w.png"},
            link = "Renversement"
        },
        ["Suspendu"] = {
            icon = {"Lifted_b.svg", "Lifted_w.svg"},
            link = "Suspendu"
        },

        -- Railjack
        ["Particule"] = {
            icon = {"Particule.png", "Particule.png"},
            link = "Dégâts#Système de Dégâts Empyrée",
            color = "#778899"
        },
        ["Balistique"] = {
            icon = {"Balistique.png", "Balistique.png"},
            link = "Dégâts#Dégâts Railjack",
            color = "#778899"
        },
        ["Plasma"] = {
            icon = {"Plasma.png", "Plasma.png"},
            link = "Dégâts#Système de Dégâts Empyrée",
            color = "#778899"
        },
        ["Ionique"] = {
            icon = {"Ionique.png", "Ionique.png"},
            link = "Dégâts#Système de Dégâts Empyrée",
            color = "#FFFF00"
        },
        ["Incendiaire"] = {
            icon = {"Incendiaire.png", "Incendiaire.png"},
            link = "Dégâts#Système de Dégâts Empyrée",
            color = "#FF0000"
        },
        ["Chimique"] = {
            icon = {"Chimique.png", "Chimique.png"},
            link = "Dégâts#Système de Dégâts Empyrée",
            color = "#008000"
        },
        ["Givre"] = {
    ...
    ["Focus"] = {
        ["Points de Focus"] = {
            icon = {"FocusLensB.png", "FocusLensC.png"},
            seal = {""}
        },
        ["Pool"] = {
            icon = {"focus_pool_white.png", "focus_pool.png"},
            seal = {""}
        },
        ["Madurai"] = {
    ...
    ["Drapeaux"] = {
        ...
        ["Urf"] = "EarthU9cutout.png"
    },

    ["Disposition"] = {
        ["0"] = {
            icon = {"Disposition0.png", "Disposition0_w.png"},
            link = "Riven_Mods#Disposition",
            color = ""
        },
        ["1"] = {
            icon = {"Disposition1.png", "Disposition1_w.png"},
            link = "Riven_Mods#Disposition",
            color = ""
        },
        ["2"] = {
            icon = {"Disposition2.png", "Disposition2_w.png"},
            link = "Riven_Mods#Disposition",
            color = ""
        },
        ["3"] = {
            icon = {"Disposition3.png", "Disposition3_w.png"},
            link = "Riven_Mods#Disposition",
            color = ""
        },
        ["4"] = {
            icon = {"Disposition4.png", "Disposition4_w.png"},
            link = "Riven_Mods#Disposition",
            color = ""
        },
        ["5"] = {
            icon = {"Disposition5.png", "Disposition5_w.png"},
            link = "Riven_Mods#Disposition",
            color = ""
        }
